...
module.exports={
    ...
    getAllPaymentByUserId: async(req, res)=>{
      try {
       ...
       const data = await db.query(`select * from payments where user_id = ${req.params.user_id};`, (err, result)=>{});
     ...
     getAllPaymentByDate: async(req, res)=>{
      try {
       ...
       const data = await db.query(`select * from payments where createdAt like '%${req.params.date}%';`, (err, result)=>{});
    ...
    getAllPaymentByTwoDates: async(req, res)=>{
      try {
       ...
       const data = await db.query(`select * from payments where createdAt >= '${req.params.start}' and createdAt <= '${req.params.end}' ;`, (err, result)=>{});
